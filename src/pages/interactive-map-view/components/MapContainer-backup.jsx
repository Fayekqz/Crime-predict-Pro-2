...
const MapContainer = ({ 
  ...
  const mockCrimeData = [
    ...
    },
    {
      ...
      severity: "High",
      status: "Active",
      description: "Breaking and entering into residential property",
    ...
    },
    {
      ...
      severity: "Low",
      status: "Closed",
      description: "Graffiti and property damage to commercial building",
    ...
    },
    {
      ...
      severity: "Medium",
      status: "Under Investigation",
      description: "Suspected drug possession and distribution",
    ...
    },
    {
      ...
      severity: "High",
      status: "Active",
      description: "Homicide investigation ongoing",
    ...
    },
    {
      ...
      severity: "High",
      status: "Active",
      description: "Data breach and identity theft",
    ...
    },
    {
      ...
      severity: "Medium",
      status: "Active",
      description: "Domestic dispute case",
    ...
    },
    {
      ...
      severity: "High",
      status: "Active",
      description: "Child abduction investigation",
    ...
    },
    {
      ...
      severity: "High",
      status: "Under Investigation",
      description: "Illegal weapons seizure",
    ...
    },
    {
      ...
      severity: "Low",
      status: "Closed",
      description: "Public disturbance incident",
  ...
  const getOverlayColor = (category) => {
    const colors = {
      ...
      "Traffic Violation": "rgba(6, 182, 212, 0.18)",
      "Public Order": "rgba(16, 185, 129, 0.18)"
    };
                ...
                >
                  <Icon 
                    name={crime?.category === "Violent Crime" ? "AlertTriangle" : 
                          ...
                          crime?.category === "Drug Crime" ? "Pill" : "MapPin"} 
